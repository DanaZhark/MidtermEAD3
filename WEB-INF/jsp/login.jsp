...
<div class="wrapper">
    <div class="container">
        ...
        <form class="form" name="form" method="POST" action="${contextPath}/login">
            <span>${message}</span>
            ...
            <a href="${contextPath}/registration" data-target="register"
               class="btn nav register modal">Registration</a>
        </form>
    </div>
